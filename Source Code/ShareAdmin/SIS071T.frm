VERSION 5.00
Begin VB.Form frmSIS071T 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "T & T Client Account Enquiry"
   ClientHeight    =   5820
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   6930
   Icon            =   "SIS071T.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
...
Set rsMain = RunSP(SpCon, "usp_FindDetailsTT", 1, gblFileKey)
If rsMain.EOF Then
...
FL_Exit:
  Exit Sub
FL_ERR:
  MsgBox Err.Description, , "SIS071T/Load"
  OpenErr = True
