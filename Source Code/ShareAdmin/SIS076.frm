VERSION 5.00
Begin VB.Form frmSIS076 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mandate Enquiry"
   ClientHeight    =   5550
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   6930
   Icon            =   "SIS076.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
...
Set rsMain = RunSP(SpCon, "usp_FindMandates", 1, gblFileKey)
 ...
 With rsMain
    ...
    If Not .EOF Then
     ...
     If Not IsNothing(!BankID) Then
       ...
       If IsNothing(!BnkName) Then
          lb(12).Caption = "Bank ID Does Not Exist. Please Correct"
       Else
          ...
          If Not IsNothing(!BNKADDR5) Then lb(16).Caption = lb(16).Caption & " " & !BNKADDR5
       End If
     End If
   End If
 End With
