...
i = RunSP(SpCon, "usp_ConvertPayments", 0, SSDBAccount.Columns(1).Text)
If i = 0 Then
   MsgBox "Conversion was successful. Cheques can be generated ad printed"
   GoTo Exit_CmdStart_Click
Else
   If i = 9 Then
      MsgBox "A Rate was not found for this currency, payment date and payment type"
      GoTo Exit_CmdStart_Click
   Else
...
Err_CmdStart_Click:
MsgBox Err & " " & Err.Description, vbOKOnly, "Error on conversion"
