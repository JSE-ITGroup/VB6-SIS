VERSION 5.00
Begin VB.Form frmSIS090 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Stock Split Menu"
   ClientHeight    =   4560
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4785
   ...
   Begin VB.CommandButton cmdBtn 
      Caption         =   "&Transfer Certs && Purge"
      Height          =   375
      Index           =   4
      Left            =   1320
      TabIndex        =   3
      ToolTipText     =   "Updates Accounts with New Certs and deletes all existing certs"
      Top             =   2760
      Width           =   2055
   End
   Begin VB.CommandButton cmdBtn 
   ...
   End
   Begin VB.CommandButton cmdBtn 
      Caption         =   "Stock  &Split Report"
      Height          =   375
      Index           =   3
      Left            =   1320
      TabIndex        =   4
      ToolTipText     =   "Report shows the stock split allocations without fractions"
      Top             =   2160
      Width           =   2055
   End
   Begin VB.CommandButton cmdBtn 
      ...
      Left            =   1320
      TabIndex        =   2
      ToolTipText     =   "Report shows the stock split allocations with fractions"
      Top             =   1560
      Width           =   2055
   End
   Begin VB.CommandButton cmdBtn 
      ...
      Left            =   1320
      TabIndex        =   1
      ToolTipText     =   "Calculates Splits based on Entry Information"
      Top             =   960
      Width           =   2055
   End
   Begin VB.CommandButton cmdBtn 
      Caption         =   "Stock Split &Entry"
      Height          =   375
      Index           =   0
      Left            =   1320
      TabIndex        =   0
      ToolTipText     =   "Activates the  Stock Split Information Entry Form"
      Top             =   360
      Width           =   2055
   End
End
Attribute VB_Name = "frmSIS090"
...
Select Case Index
Case 0
frmSIS090.Visible = False
frmSIS091.Show 0 ' Bonus Entry
'--
Case 1
frmSIS090.Visible = False
frmSIS092.Show 0 ' Calculate Splits
'--
...
Title = "Stock Split Letters Entry"
