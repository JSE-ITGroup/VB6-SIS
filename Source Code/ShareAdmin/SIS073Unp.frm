...
Begin VB.Form frmSIS073Unp 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Client Unpaid Cheques"
   ClientHeight    =   4650
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   8940
   Icon            =   "SIS073Unp.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin SSDataWidgets_B.SSDBGrid grd 
      ...
      Columns(4).Caption=   "Reconciled"
      Columns(4).Name =   "Reconciled"
      Columns(4).DataField=   "Column 4"
      Columns(4).DataType=   11
      Columns(4).FieldLen=   5
      Columns(5).Width=   3200
      Columns(5).Caption=   "Replaced Cheque"
      Columns(5).Name =   "Replaced Cheque"
   ...
   End
End
Attribute VB_Name = "frmSIS073Unp"
...
Set rsMain = RunSP(SpCon, "usp_FindUnpDividends", 1, gblFileKey)
UpdateScreen
' ready message
frmMDI.txtStatusMsg.SimpleText = gblReadyMsg
Screen.MousePointer = vbDefault
 ...
 With rsMain
    If Not .EOF Then
      ...
      Do While Not .EOF
        ...
        totamt = totamt + !ChqAmt
        grd.AddItem sRowinfo
        .MoveNext
      Loop
    End If
  End With
  TxtTotal = Format(totamt, "#,###.00")
End Sub
