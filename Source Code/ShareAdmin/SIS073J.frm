...
Begin VB.Form frmSIS073J 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Stock Exchange Client Payments History"
   ClientHeight    =   4650
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   14175
   Icon            =   "SIS073J.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin SSDataWidgets_B.SSDBGrid grd 
      ...
      Columns(6).Caption=   "Replacement Cheque"
      Columns(6).Name =   "Replacement Cheque"
...
Set rsMain = RunSP(SpCon, "usp_FindDividends", 1, gblFileKey, gblReply)
UpdateScreen
ClientiD = gblFileKey
' ready message
frmMDI.txtStatusMsg.SimpleText = gblReadyMsg
...
Private Sub UpdateScreen()
 ...
 lb(0).Caption = frmSIS070J.grd.Columns(1).Text
 lb(1).Caption = frmSIS070J.grd.Columns(0).Text
 With rsMain
    If Not .EOF Then
      grd.RemoveAll
      ...
      Do While Not .EOF
        ...
        sRowinfo = sRowinfo & !ChqDat & vbTab & Format(!ChqAmt, "#,##0.00")
