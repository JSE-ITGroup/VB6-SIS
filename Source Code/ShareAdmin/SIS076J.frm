VERSION 5.00
Begin VB.Form frmSIS076J 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Stock Exchange Mandate Enquiry"
   ClientHeight    =   5550
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   6930
   Icon            =   "SIS076J.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
...
Set rsMain = RunSP(SpCon, "usp_FindMandatesSE", 1, gblFileKey, gblReply)
