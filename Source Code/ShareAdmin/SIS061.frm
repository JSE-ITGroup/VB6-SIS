...
Begin VB.Form frmSIS061 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Bonus  Information Details"
   ClientHeight    =   2730
   ClientLeft      =   1095
   ClientTop       =   330
   ClientWidth     =   6750
   Icon            =   "SIS061.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSMask.MaskEdBox meb 
      ...
      Left            =   2160
      TabIndex        =   1
      ToolTipText     =   "Enter the number of bonus stocks to be allocated"
      Top             =   1200
      Width           =   975
      _ExtentX        =   1720
      _ExtentY        =   450
   ...
   Begin MSMask.MaskEdBox meb 
      ...
      Left            =   2160
      TabIndex        =   2
      ToolTipText     =   "Enter the base amount of stocks for the bonus stocks."
      Top             =   1560
      Width           =   975
      _ExtentX        =   1720
      _ExtentY        =   450
...
If meb(0) = "" Then ' date on record
   iErr = 111
   csvShowUsrErr iErr, "Bonus Information Entry"
   meb(0).SetFocus
   GoTo Validate_Exit
 Else
...
Validate_Err:
  ...
  csvShowUsrErr iErr, "Bonus Entry"
  IsValid = False
  GoTo Validate_Exit
'--
End Function
